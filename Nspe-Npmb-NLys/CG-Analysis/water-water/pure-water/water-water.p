...
plot 'H-H.dist.charmm.tgt'  using 1:($2 == 0.0 ? NaN : $2) with lines linewidth 3 linecolor rgb 'black' title 'AA' ,\
'H-H.dist.new'  using 1:($2 < 0.00001 ? NaN : $2) with lines linewidth 3 linecolor rgb 'red' dashtype "-" title 'CG' ,\
