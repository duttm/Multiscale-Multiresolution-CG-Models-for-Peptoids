...
plt.figure()
ax = plt.gca()
im = ax.imshow(DG.T, cmap=cm.Set1, extent=[minv1,maxv1,minv2,maxv2], origin='lower', aspect='auto',norm=hello.colors.PowerNorm(gamma=1)) 
...
cbar = plt.colorbar(im, cax=cax, ticks=[0, 0.25, 0.50,1,2,4,8,10])
