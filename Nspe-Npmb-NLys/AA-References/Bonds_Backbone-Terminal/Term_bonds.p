...
set output 'P3_Bonds_term_9_15.png'
...
plot 'Nterm-BB1.dist.new'  using  1:($2 == 0.00 ? NaN : $2) with lines title "Nterm-BB1" lt rgb "#2243B6" linewidth 3 


set label 1 '(B)'
plot 'BB11-Cterm.dist.new'  using  1:($2 == 0.00 ? NaN : $2) with lines title "BB11-Cterm" lt rgb "#2243B6" linewidth 3 
